...
static const char *cmd_names_ss[] = { "ss", "ss", NULL };
...
static const struct cmd cmd_table[] = {
    ...
    {
        FIELD_INIT(.names, cmd_names_ss),
        FIELD_INIT(.exec, cmd_ss),
        FIELD_INIT(.desc, "Skysense submodule"),
        FIELD_INIT(.help, CLI_CMD_HELPTEXT_ss),
        FIELD_INIT(.requires_device, true),
        FIELD_INIT(.requires_fpga, true),
        FIELD_INIT(.allow_while_streaming, false),
    },    
